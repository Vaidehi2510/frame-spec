...
The definitions here are grounded in the repository's current direction and the architecture described in [../references/Intelligence Hub Whitepaper - v4.md](../references/Intelligence%20Hub%20Whitepaper%20-%20v4.md).
